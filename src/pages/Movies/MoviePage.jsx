        ...
        <div className="movies__main">
          ...
          {!isLoading && !isError && movies.length === 0 && (
            <div className="empty">
              ...
              {/* 왜 비었는지 알 수 있도록 현재 상태를 표시합니다.
                  원인을 찾은 뒤에는 이 블록을 지워도 됩니다. */}
              {!keyword && (
                <pre className="empty__debug">
{`요청 주소 : /movie/popular?language=ko-KR&page=${page}
상태      : ${status}
받은 개수 : ${movies.length}
전체 결과 : ${data?.totalResults ?? "-"}`}
                </pre>
              )}
